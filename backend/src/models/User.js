...
if (mongoose.models && mongoose.models.User) {
  ...
  const userSchema = new mongoose.Schema({
    ...
    analytics: {
      ...
      totalPortfoliosCreated: { type: Number, default: 0 },
...
>>>>>>> 804ddfb (changes)
  ...
  // Add login history
  userSchema.methods.addLoginHistory = async function(ipAddress, userAgent, success) {
    this.loginHistory.push({
      timestamp: new Date(),
      ipAddress,
      userAgent,
  ...
  // Auto verify for test environment
  userSchema.methods.autoVerifyForTest = async function() {
